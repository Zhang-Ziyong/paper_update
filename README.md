...
<thead><tr><th>日期</th><th>标题</th><th>摘要</th></tr></thead>
<tbody>
<tr><td>2026-06-10</td><td>Koopman-based NMPC for Virtually Coupled Train Control System<br><a href='http://arxiv.org/pdf/2606.11858'>论文</a></td><td>本文提出了一种基于Koopman的非线性模型预测控制方法，用于解决虚拟耦合列车系统的跟踪控制问题。
◆通过闭式可观函数，将包含列车动力学、各类约束及防撞要求的复杂非线性列车模型系统性地提升至有限维Koopman空间。
◆沿平移预测轨迹冻结仿射变参数提升预测器，将原本复杂的在线最优控制问题...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-07</td><td>Towards End to End Motion Planning and Execution for Autonomous Underwater Vehicles Using Reinforcement Learning<br><a href='http://arxiv.org/pdf/2606.08513'>论文</a></td><td>◆ 中文摘要生成失败，请检查 API 配置后重新运行...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-10</td><td>MPPI-based Informative Trajectory Planning for Search and Capture of Drifting Targets with ASVs<br><a href='http://arxiv.org/pdf/2606.12019'>论文</a></td><td>本文提出了一种混合规划框架，用于...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-08</td><td>Submodular Optimization with Applications to Decision and Control<br><a href='http://arxiv.org/pdf/2606.10192'>论文</a></td><td>本文综述了次模优化在决策与控制领域的理论、算法与应用，为子集选择问题提供了统一的组合框架。文章系统梳理了次模函数的结构特性、实际约束族以及单调与非单调最大化的近似算法与最新难解性结果。
◆强调了实际可实施的贪心算法，并利用曲率和次模比率实现了依赖于实例的算法精度改进。
◆明确界定了典型控制目标的次模性边界，指出可控性格拉姆矩阵的秩等泛函具有次模性，而稳态卡尔曼滤波误差等密切相关的目标却不具备次模或超模性。
◆全面调研了从传感器调度到信息路径规划等广泛的应用场景，并提炼出跨领域的未来开放研究方向。</td></tr>
<tr><td>2026-06-08</td><td>FlexPath: Learned Semantic Path Priors for Image-Based Planning<br><a href='http://arxiv.org/pdf/2606.10167'>论文</a> | <a href='https://github.com/FraunhoferIVI/FlexPath'>代码</a></td><td>论文提出了FlexPath框架，解决了现有基于学习的路径规划器局限于最短路径目标而缺乏灵活性的问题。该框架的核心贡献在于将路径可行性与规划偏好进行解耦。
◆提出两阶段规划框架，第一阶段通过模仿学习从视觉地图中提取任务无关的可行路径空间先验。
◆在第二阶段引入可微路径形状目标，将空间先验高效适应至特定任务，无需重新学习路径结构。
◆实现单模型多目标灵活适应，仅需轻量的目标级适应即可满足最短路径、避障、语义感知及路标引导等多种偏好。
◆在性能上超越现有最优方法并展现强零样本泛化能力，同时保持与经典规划器的推理兼容性。</td></tr>
<tr><td>2026-06-08</td><td>Uncertainty-Aware Motion Planning for Autonomous Driving in Mixed Traffic Environment<br><a href='http://arxiv.org/pdf/2606.09958'>论文</a></td><td>本文针对混合交通环境下自动驾驶运动规划问题，指出将人类意图预测视为确定性状态会导致不安全决策。为此，本文提出了不确定性感知运动规划方法UAMP，将意图预测的不确定性纳入决策框架。
◆提出近距感知不确定性估计器，量化交互条件下的意图不确定性，构建不确定性引导的联合意图分布。
◆引入不确定性校准价值学习UCVL，修正直接将不确定预测纳入观测所导致的价值函数学习偏差。
实验证明，该方法在维持交通效率的同时显著提升了自动驾驶的安全性与舒适性。</td></tr>
...
<tbody>
<tr><td><a href='https://github.com/hku-mars/FAST_LIO'>FAST_LIO</a></td><td>4777</td><td>A computationally efficient and robust LiDAR-inert</td></tr>
<tr><td><a href='https://github.com/hku-mars/FAST-LIVO2'>FAST-LIVO2</a></td><td>4179</td><td>FAST-LIVO2: Fast, Direct LiDAR-Inertial-Visual Odo</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/LiDAR_IMU_Init'>LiDAR_IMU_Init</a></td><td>1418</td><td>[IROS2022] Robust Real-time LiDAR-inertial Initial</td></tr>
<tr><td><a href='https://github.com/hku-mars/livox_camera_calib'>livox_camera_calib</a></td><td>1257</td><td>This repository is used for automatic calibration </td></tr>
<tr><td><a href='https://github.com/hku-mars/Point-LIO'>Point-LIO</a></td><td>1234</td><td>Point-LIO</td></tr>
<tr><td><a href='https://github.com/hku-mars/SUPER'>SUPER</a></td><td>931</td><td>SUPER</td></tr>
<tr><td><a href='https://github.com/hku-mars/FAST-Calib'>FAST-Calib</a></td><td>925</td><td>A Handy Extrinsic Calibration Tool for LiDAR-camer</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/M-detector'>M-detector</a></td><td>632</td><td>M-detector</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/HBA'>HBA</a></td><td>587</td><td>[RAL 2023] A globally consistent LiDAR map optimiz</td></tr>
<tr><td><a href='https://github.com/hku-mars/ROG-Map'>ROG-Map</a></td><td>562</td><td>ROG-Map</td></tr>
<tr><td><a href='https://github.com/hku-mars/IKFoM'>IKFoM</a></td><td>552</td><td>A computationally efficient and convenient toolkit</td></tr>
...
<tr><td><a href='https://github.com/ethz-asl/nbvplanner'>nbvplanner</a></td><td>441</td><td>A real-time capable exploration and inspection pat</td></tr>
