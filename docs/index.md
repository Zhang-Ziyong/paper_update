...
<tr><td>2026-06-02</td><td>PixVOD: Pixel-Distributed Direct Visual Odometry and Depth Estimation<br><a href='http://arxiv.org/pdf/2606.03989'>论文</a></td><td>本文提出PixVOD方法，实现跨像素的全并行视觉里程计与深度估计，旨在通过像素内直接计算减少原始数据传输的冗余与低效。该方法改变了传统将原始像素数据传出传感器的模式，让像素在本地合成更高级别信号。
◆提出基于高斯置信传播的像素级分布式计算框架，使传感器处理器通过交换信息对相机运动达成共识，并结合逐像素光度观测与表面法线先验...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-05-29</td><td>ScaRF-SLAM: Scale-Consistent Reconstruction with Feed-Forward Models and Classical Visual SLAM<br><a href='http://arxiv.org/pdf/2606.00307'>论文</a></td><td>本文提出ScaRF-SLAM框架，解决了直接将几何基础模型用于SLAM跟踪时易受模型预测误差影响的问题。
◆提出解耦框架，用经典视觉SLAM实现鲁棒低延迟跟踪，将GFMs专用于建图，通过锚定位姿和优化深度尺度防止误差传播。
◆构建多关键帧子地图，通过轻量级尺度优化保证尺度一致性，并在子地图内执行基于投影的点云融合与在线更新。
◆引入一个富含闭环的建筑...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-05-28</td><td>The JADES Mass-Metallicity and Fundamental Metallicity Relations at $z\gtrsim2$ Using New High-Redshift Metallicity Calibrations<br><a href='http://arxiv.org/pdf/2605.30513'>论文</a></td><td>本文利用JWST/JADES的601个星系堆叠光谱，测量了红移1.4至7.0间的质量金属丰度关系与基本金属丰度关系。
◆采用基于高红移星系的最新强线金属丰度标定方法，提升了早期宇宙金属丰度测量的可靠性。
◆发现红移5...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-03</td><td>MAD: Mapping-Aware World Models for Agile Quadrotor Flight<br><a href='http://arxiv.org/pdf/2606.04534'>论文</a></td><td>本文提出了MAD，一种用于敏捷四旋翼飞行的几何感知世界模型，解决了传统反应式映射无法记忆观测区域和推断占据空间的问题。
◆摒弃原始图像重建，通过学习循环隐式动力学来重建以机器人为中心的占据与可见度栅格地图及本体感受状态，强制隐状态编码与避障直接相关的局部几何、可见度历史和自运动。
◆在DiffAero框架中利用GPU并行建图模块进行训练，为占据和可见度提供高吞吐量的监督信号。
◆结合想象和特征提取机制，提出了基于MAD-Dreamer、PPO和SHAC的三种策略学习模式，显著提升了导航和竞速任务的成功率、飞行速度及跨任务迁移能力。
◆成功将策略部署于真实四旋翼飞行器，在感知受限的室内外环境中实现安全飞行，并在森林实验中达到5.05米每秒...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-04</td><td>3D Underwater Path Planning via Generative Flow Field Surrogates<br><a href='http://arxiv.org/pdf/2606.06077'>论文</a></td><td>本文提出了基于生成流场替代模型的三维水下路径规划方法，解决了高保真CFD模拟计算成本过高而无法用于自主水下航行器机载路径规划的难题。核心贡献在于将cGAN模型作为CFD的替代方案整合到能量加权A*路径规划框架中，实现复杂螺旋桨尾流下的快速节能规划。
◆引入正则化PatchGAN和带自注意力的2D3DGAN架构，作为高计算成本RANS CFD数据的直接替代模型。
◆构建分层生成流水线，仅凭标量运行条件输入即可合成128的三次方体素流场，将推理时间从...[摘要不完整，待更新]</td></tr>
...
<tr><td>2026-06-03</td><td>Joint 3D Trajectory and Power Allocation for HAPs-UAV Bistatic ISARAC in Low-Altitude Networks<br><a href='http://arxiv.org/pdf/2606.04600'>论文</a></td><td>本文提出了一种低空网络中高空平台与无人机双基地ISARAC系统的联合三维轨迹与功率分配方案。该方案由高空平台发射波形提供广域通信，无人机被动收集回波实现高分辨率SAR成像。研究构建了满足SAR成像质量、总能耗及无人机动态约束的用户总速率最大化非凸问题。
◆提出了HAPs-UAV双基地ISARAC新架构，协同实现了广域...[摘要不完整，待更新]</td></tr>
...
<tbody>
<tr><td><a href='https://github.com/hku-mars/FAST_LIO'>FAST_LIO</a></td><td>4754</td><td>A computationally efficient and robust LiDAR-inert</td></tr>
<tr><td><a href='https://github.com/hku-mars/FAST-LIVO2'>FAST-LIVO2</a></td><td>4154</td><td>FAST-LIVO2: Fast, Direct LiDAR-Inertial-Visual Odo</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/loam_livox'>loam_livox</a></td><td>1606</td><td>A robust LiDAR Odometry and Mapping (LOAM) package</td></tr>
<tr><td><a href='https://github.com/hku-mars/FAST-LIVO'>FAST-LIVO</a></td><td>1600</td><td>A Fast and Tightly-coupled Sparse-Direct LiDAR-Ine</td></tr>
<tr><td><a href='https://github.com/hku-mars/LiDAR_IMU_Init'>LiDAR_IMU_Init</a></td><td>1414</td><td>[IROS2022] Robust Real-time LiDAR-inertial Initial</td></tr>
<tr><td><a href='https://github.com/hku-mars/livox_camera_calib'>livox_camera_calib</a></td><td>1253</td><td>This repository is used for automatic calibration </td></tr>
<tr><td><a href='https://github.com/hku-mars/Point-LIO'>Point-LIO</a></td><td>1229</td><td>Point-LIO</td></tr>
<tr><td><a href='https://github.com/hku-mars/SUPER'>SUPER</a></td><td>924</td><td>SUPER</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/FAST-Calib'>FAST-Calib</a></td><td>915</td><td>A Handy Extrinsic Calibration Tool for LiDAR-camer</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/r2live'>r2live</a></td><td>779</td><td>R2LIVE: A Robust, Real-time, LiDAR-Inertial-Visual</td></tr>
<tr><td><a href='https://github.com/hku-mars/ImMesh'>ImMesh</a></td><td>738</td><td>ImMesh: An Immediate LiDAR Localization and Meshin</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/Voxel-SLAM'>Voxel-SLAM</a></td><td>629</td><td>Voxel-SLAM</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/MARSIM'>MARSIM</a></td><td>535</td><td>MARSIM是一款轻量级、点云逼真的LiDAR无人机模拟器。</td></tr>
<tr><td><a href='https://github.com/hku-mars/LTAOM'>LTAOM</a></td><td>499</td><td>LTAOM</td></tr>
<tr><td><a href='https://github.com/hku-mars/GS-SDF'>GS-SDF</a></td><td>473</td><td>[IROS 2025] LiDAR-Augmented Gaussian Splatting and</td></tr>
<tr><td><a href='https://github.com/hku-mars/Swarm-LIO2'>Swarm-LIO2</a></td><td>434</td><td>[T-RO 24] Swarm-LIO2: Decentralized, Efficient LiD</td></tr>
<tr><td><a href='https://github.com/hku-mars/LIV_handhold_2'>LIV_handhold_2</a></td><td>398</td><td>LIV-Eye: A Low-Cost LiDAR-Inertial-Visual Fusion 3</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/UMI-3D'>UMI-3D</a></td><td>235</td><td>UMI-3D SLAM and Data Processing Pipeline: https://</td></tr>
...
<tr><td><a href='https://github.com/hku-mars/BDM'>BDM</a></td><td>155</td><td>Memory-Efficient Boundary Map for Large-Scale Occu</td></tr>
...
<tr><td><a href='https://github.com/ethz-asl/voxblox'>voxblox</a></td><td>1633</td><td>A library for flexible voxel-based mapping, mainly</td></tr>
...
<tr><td><a href='https://github.com/ethz-asl/aerial_mapper'>aerial_mapper</a></td><td>619</td><td>Real-time Dense Point Cloud, Digital Surface Map (</td></tr>
...
<tr><td><a href='https://github.com/ethz-asl/mav_voxblox_planning'>mav_voxblox_planning</a></td><td>566</td><td>MAV planning tools using voxblox as the map repres</td></tr>
...
<tr><td><a href='https://github.com/ethz-asl/mav_control_rw'>mav_control_rw</a></td><td>442</td><td>Control strategies for rotary wing Micro Aerial Ve</td></tr>
