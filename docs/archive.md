...
<ol>
<li><a href='#slam'>SLAM (127篇)</a></li>
<li><a href='#sfm'>SFM (64篇)</a></li>
<li><a href='#image-matching'>Image Matching (20篇)</a></li>
<li><a href='#obstacle-avoidance'>Obstacle Avoidance (131篇)</a></li>
<li><a href='#navigation'>Navigation (137篇)</a></li>
<li><a href='#motion-planning'>Motion Planning (198篇)</a></li>
<li><a href='#sensor-calibration'>Sensor Calibration (36篇)</a></li>
<li><a href='#sensor-undistortion'>Sensor Undistortion (77篇)</a></li>
</ol>
</details>

<h2 id='slam'>SLAM (127篇)</h2>
...
<h2 id='obstacle-avoidance'>Obstacle Avoidance (131篇)</h2>
...
<h2 id='navigation'>Navigation (137篇)</h2>
...
<h2 id='motion-planning'>Motion Planning (198篇)</h2>
...
<tr><td>2026-06-06</td><td>SynthICL: Scalable In-context Imitation Learning with Synthetic Data<br><a href='http://arxiv.org/pdf/2606.08154'>论文</a></td><td>该论文提出了SynthICL框架，专注于解决上下文模仿学习(In-context Imitation Learning, ICIL)在可扩展性方面的核心挑战。研究指出，传统方法依赖深度传感、精确相机标定和真实世界数据，限制了其实际应用范围。

SynthICL的核心思路是构建一个完全基于RGB合成数据的数据生成流水线，并在此基础上训练基于流匹配(flow-matching)的Transformer策略，从而摆脱对真实世界数据的依赖。

◆创新点一：设计了高保真合成数据生成流水线，仅需RGB输入即可产生训练数据，避免了深度传感器和相机标定的需求。

◆创新点二：采用流匹配Transformer作为策略网络，实现了对演示示例的高效上下文条件化。

◆创新点三：引入了下一子目标图像预测机制，使模型能够进行更精确且视觉对齐的动作控制。

◆创新点四：在16个未见过的真实世界操作任务上进行评估，仅需测试时单条示范即可达到79%的平均成功率，优于现有方法。</td></tr>
...
<h2 id='sensor-undistortion'>Sensor Undistortion (77篇)</h2>
