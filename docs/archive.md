...
<ol>
<li><a href='#slam'>SLAM (114篇)</a></li>
<li><a href='#sfm'>SFM (56篇)</a></li>
<li><a href='#image-matching'>Image Matching (19篇)</a></li>
<li><a href='#obstacle-avoidance'>Obstacle Avoidance (121篇)</a></li>
<li><a href='#navigation'>Navigation (119篇)</a></li>
<li><a href='#motion-planning'>Motion Planning (182篇)</a></li>
<li><a href='#sensor-calibration'>Sensor Calibration (33篇)</a></li>
<li><a href='#sensor-undistortion'>Sensor Undistortion (69篇)</a></li>
</ol>
</details>

<h2 id='slam'>SLAM (114篇)</h2>
...
<h2 id='obstacle-avoidance'>Obstacle Avoidance (121篇)</h2>
...
<h2 id='navigation'>Navigation (119篇)</h2>
...
<h2 id='motion-planning'>Motion Planning (182篇)</h2>
...
<tr><td>2026-06-03</td><td>A Geometry-Informed Computer Vision Method for Detecting and Examining Overtaking Vehicles From A Bicycle<br><a href='http://arxiv.org/pdf/2606.23699'>论文</a></td><td>本文针对自行车骑行研究中超车事件人工标注的瓶颈,提出了一种基于几何信息的计算机视觉流水线,利用单一自行车摄像头即可自动检测后方超车车辆。系统结合RT-DETR目标检测与ByteTrack多目标跟踪,通过三阶段几何验证模块(方位角趋势、表观尺寸增长、空间确认)过滤误检,无需多传感器或显式相机标定。在315个真实超车事件上取得97.8%召回率且零误报,平均提前2.44秒识别超车意图,84.1%的事件超过1.5秒人类反应阈值,可用于主动骑手预警。基于96个事件的横向距离分析显示33.3%未达5英尺法定间距,与既有研究一致。

◆ 提出基于透视投影原理的三阶段几何验证模块,在无标定条件下实现高召回零误报的超车事件检测
◆ 利用边界框几何特征实现免标定横向距离估计,留一交叉验证平均绝对误差仅13-14厘米
◆ 提前2.44秒预测超车意图,为低成本主动安全预警系统提供可行基础
◆ 自动化流程突破了仪器化自行车研究的人工标注瓶颈,支持大规模城市车辆-自行车交互分析...[摘要不完整，待更新]</td></tr>
