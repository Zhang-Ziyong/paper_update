...
<ol>
<li><a href='#slam'>SLAM (138篇)</a></li>
<li><a href='#sfm'>SFM (68篇)</a></li>
<li><a href='#image-matching'>Image Matching (21篇)</a></li>
<li><a href='#obstacle-avoidance'>Obstacle Avoidance (146篇)</a></li>
<li><a href='#navigation'>Navigation (165篇)</a></li>
<li><a href='#motion-planning'>Motion Planning (228篇)</a></li>
<li><a href='#sensor-calibration'>Sensor Calibration (37篇)</a></li>
<li><a href='#sensor-undistortion'>Sensor Undistortion (86篇)</a></li>
</ol>
</details>

<h2 id='slam'>SLAM (138篇)</h2>
...
<tr><td>2026-07-01</td><td>EPO: Boosting 3D Foundation Models with Edge-based Pose Optimization<br><a href='http://arxiv.org/pdf/2607.00579'>论文</a></td><td>EPO提出了一种基于边缘的姿态优化框架,专门用于提升三维基础模型生成的Structure-from-Motion重建结果的几何精度。针对三维基础模型跳过特征提取与匹配环节导致精度不足的问题,EPO通过边缘图对齐作为几何优化的代理,完全避免了对特征轨迹的依赖。

◆ 创新性地提出无轨迹的几何优化框架,无需构建三维点与多图像之间的显式对应关系,保留原始流程的速度优势

◆ 采用边缘图对齐作为几何优化的代理信号,替代传统Bundle Adjustment中的特征轨迹机制

◆ 框架完全可微分,有利于端到端的优化训练

◆ 在多个数据集和任务上的实验表明,EPO在精度上匹配或超越类Bundle Adjustment方法,同时大幅降低运行时间和内存占用

◆ 低内存特性使其可在消费级硬件上运行,突破了现有精细化方法对高配硬件的依赖限制...[摘要不完整，待更新]</td></tr>
...
<h2 id='obstacle-avoidance'>Obstacle Avoidance (146篇)</h2>
...
<h2 id='navigation'>Navigation (165篇)</h2>
...
<h2 id='motion-planning'>Motion Planning (228篇)</h2>
...
在nuScenes基准上的实验表明，RCT-AD在感知精度、运动预测和规划鲁棒性上均优于近期端到端基线，同时保持适合实时部署的计算效率。</td></tr>
<tr><td>2026-07-04</td><td>How (not) to prove (un)distortion for diffeomorphisms of one-manifolds<br><a href='http://arxiv.org/pdf/2607.04001'>论文</a></td><td>本文研究一维流形上微分同胚群的扭曲(distortion)问题,聚焦于以下核心问题:在更光滑的群中未扭曲的微分同胚,是否必然在低光滑度群中扭曲。已知(1,2)情形存在反例,(2,∞)情形不存在。

◆ 证明了Liouville上循环的漂移对C²扭曲的微分同胚为零,从而排除了其作为(2,3)情形新障碍的可能性,并指出任何类似上循环均不构成障碍。

◆ 推广了arXiv:2507.13770的方法,证明实直线上紧支撑的C²扭曲微分同胚,只要其光滑度高于C^{2r+2},则在C^r群中仍保持扭曲性。

◆ 建立了以等距作用上循环漂移作为扭曲障碍的统一框架,涵盖对数导数与射影导数等几何对象。

◆ 揭示了一个深刻的刚性现象:在实线上,若C²扭曲微分同胚具有足够高的正则性,则无法通过提升光滑度来&quot;消除&quot;扭曲性。</td></tr>
