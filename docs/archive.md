...
<li><a href='#sfm'>SFM (66篇)</a></li>
<li><a href='#image-matching'>Image Matching (20篇)</a></li>
<li><a href='#obstacle-avoidance'>Obstacle Avoidance (139篇)</a></li>
<li><a href='#navigation'>Navigation (152篇)</a></li>
<li><a href='#motion-planning'>Motion Planning (214篇)</a></li>
...
<h2 id='obstacle-avoidance'>Obstacle Avoidance (139篇)</h2>
...
<h2 id='navigation'>Navigation (152篇)</h2>
...
<h2 id='motion-planning'>Motion Planning (214篇)</h2>
...
<tr><td>2026-06-06</td><td>SynthICL: Scalable In-context Imitation Learning with Synthetic Data<br><a href='http://arxiv.org/pdf/2606.08154'>论文</a></td><td>SynthICL提出了一种可扩展的上下文模仿学习框架,完全基于RGB合成数据训练策略,无需深度传感、相机标定或真实世界数据,大幅降低了数据获取成本。该方法通过构建高保真数据生成流水线,结合流匹配(flow-matching)变换器策略架构,实现了高效可扩展的策略学习。模型在测试时仅需一个示范即可泛化到新任务,在16个未见过的真实世界操作任务上取得了79%的平均成功率,优于现有方法。

◆ 完全基于合成RGB数据训练上下文模仿学习策略,摆脱对深度传感器、精确相机标定和真实数据的依赖,具备良好的可扩展性

◆ 构建了高保真的ICL数据生成流水线,系统化地产生多样化训练数据

◆ 采用流匹配变换器作为策略网络,提升对复杂动作分布的建模能力

◆ 引入子目标预测机制,训练模型预测下一阶段的子目标图像,实现了更精确、视觉锚定的控制

◆ 在仅提供单次示范的条件下,在16个真实操作任务上达到79%平均成功率,验证了方法的强泛化能力...[摘要不完整，待更新]</td></tr>
