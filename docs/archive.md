...
<h2 id='navigation'>Navigation (74篇)</h2>
...
<tr><td>2026-06-08</td><td>Bayesian Optimization for Learning Nonlinear MPC in Autonomous Agent Navigation<br><a href='http://arxiv.org/pdf/2606.14763'>论文</a></td><td>本文提出了一种无地图框架，将反应式滚动时域规划与非线性模型预测控制紧密结合，以解决动态未知环境下的自主导航挑战。
◆提出基于激光雷达的高斯占用表示与A*算法生成无碰撞轨迹，并利用包含平滑Sigmoid障碍屏障的非线性MPC进行轨迹跟踪。
◆采用基于树状Parzen估计器的离线贝叶斯优化方案，自动识别近最优控制器参数，克服了系统对参数敏感性的弱点。
◆引入高斯过程代理模型进行参数敏感性分析，为理解优化景观提供了深入见解。
实验表明该框架具备机器人通用性，仿真指标平均提升38.9%，且参数从仿真到实体的迁移无需额外微调，在真实四足机器人上达到了90.0%的导航成功率。</td></tr>
...
<h2 id='motion-planning'>Motion Planning (106篇)</h2>
