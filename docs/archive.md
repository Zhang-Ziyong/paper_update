...
<tr><td>2026-06-18</td><td>UNSEEN: Uncertainty-aware Navigation via Sparse Estimation in Unknown Environments<br><a href='http://arxiv.org/pdf/2606.20755'>论文</a></td><td>◆提出UNSEEN，一个仅依赖前置相机的统一视觉导航框架，面向未知环境中的资源受限机器人。

◆将定位、稀疏建图与规划紧密耦合，显式建模并传播位姿和地图不确定性，避免传统模块化管线的信息割裂。

◆UNSEEN-SLAM以6Hz估计稀疏地图、机器人位姿及其不确定性，在运动模糊、弱纹理和光照变化下更稳健。

◆UNSEEN-Plan在滚动时域内联合优化任务推进与估计精度，使机器人主动选择更有利于感知和定位的轨迹。

◆仿真和真实实验表明，该方法实现100%任务成功率，定位误差降低9.8%，规划带来的估计精度最高提升45%。</td></tr>
